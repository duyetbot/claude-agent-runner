...
SERVICE_ACCOUNT = env("SANDBOX_SERVICE_ACCOUNT", "agent-runner")
...
SECRET_REF_NAME = env("SANDBOX_SECRET_REF", "agent-runner-secret")
CONFIGMAP_REF_NAME = env("SANDBOX_CONFIGMAP_REF", "agent-runner-config")
PVC_ACCESS_MODE = env("SANDBOX_PVC_ACCESS_MODE", "ReadWriteOnce")
APP_LABEL = env("SANDBOX_APP_LABEL", "agent-runner")
